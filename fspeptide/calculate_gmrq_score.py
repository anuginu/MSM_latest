def calculate_scor(feature_list,extracted_feat):
  ...
  tica_model = tICA(lag_time=2, n_components=5, kinetic_mapping=True)
  tica_model.fit(new_diheds)                                         
  tica_trajs = tica_model.transform(new_diheds)                      
  from msmbuilder.cluster import MiniBatchKMedoids                        
  clusterer = MiniBatchKMedoids(n_clusters=200, random_state=42)
  ...
  return best_score_mean,best_score
